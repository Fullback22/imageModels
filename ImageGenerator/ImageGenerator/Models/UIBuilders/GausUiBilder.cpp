...
void GausUiBilder::creatUi(QVBoxLayout& targetLayout)
{
	...
	parametrs.push_back(new UiModelParametr(targetLayout, QString::fromLocal8Bit("Ñðåäíåå"), 255));
	parametrs.push_back(new UiModelParametr(targetLayout, QString::fromLocal8Bit("ÑÊÎ"), 90));
